...
$branch=$_POST['branch'];
$quesid=$_GET['quesid'];
mysqli_query($con,"INSERT INTO `practical_ans`(`practical_ans`, `subject`, `semester`, `branch`, `stud_email`,`quesid`) VALUES ('$practicalanswers','$subject','$semester','$branch','$sessionemail','$quesid')");
