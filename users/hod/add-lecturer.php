...
include "nav.php"; 
//firstname middlename lastname email phonenumber birthdate gender branch password confirmpassword
...
if(isset($_POST['submit'])){
    ...
    if($confirmpassword!=$password){
        ...
        echo "<script>alert('Lecturer Registered Successfuly!!!')</script>";
    }
