...
if (isset($_POST['submit'])) {
    ...
    if ($confirmpassword != $password) {
        ...
        //insert
        mysqli_query($con, "INSERT INTO `hod_details`(`firstname`, `middlename`, `lastname`, `email`, `phonenumber`, `birthdate`, `gender`, `branch`, `password`) VALUES ('$firstname','$middlename','$lastname','$email','$phonenumber','$birthdate','$gender','$branch','$password')");
        mysqli_query($con, "INSERT INTO `user_details`(`email`, `password`, `role`) VALUES ('$email','$password','HOD')");
        echo "<script>alert('HOD Registered Successfuly!!!')</script>";
    }
}
?>
