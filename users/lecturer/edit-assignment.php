                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group m-t-30">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="assignment-number" name="assignment-number" placeholder="Assignment Number" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="row form-group mt-4">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="assignment-questions" id="assignment-questions" rows="9" placeholder="Notice Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group m-t-30">
