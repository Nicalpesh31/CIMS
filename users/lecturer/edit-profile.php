...
if (isset($_POST['submit'])) {
    ...
    $updatequery=mysqli_query($con,"UPDATE `lecturer_details` SET `firstname`='$firstname',`middlename`='$middlename',`lastname`='$lastname',`email`='$email',`phonenumber`='$phonenumber',`birthdate`='$birthdate',`gender`='$gender', `branch`='$branch' WHERE `email`='$sessionemail'");
...
$sql=mysqli_query($con,"select * from `lecturer_details` where `email`='$sessionemail'");
...
$sqlupdpass=mysqli_query($con,"UPDATE `lecturer_details` SET `password`='$newpassword' WHERE `email`='$sessionemail'");
