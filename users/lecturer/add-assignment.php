...
if(isset($_POST['submit'])){
    //myfile submit subject semester branch
     ...
     mysqli_query($con,"INSERT INTO `assignment`(`branch`, `subject`, `semester`,`status`,`added_by`,`contents`) VALUES ('$branch','$subject','$semester','unpublished','$sessionemail','$practicalquestions')");
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <option value="8">8th</option>
                                            ...
                                            <div class="row form-group mt-4">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="practical-questions" id="practical-questions" rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group m-t-30">
