...
<main id="main">
    <section class="container justify-content-center">
        <div class="container text-center">
            <h2 class="h2 display-4 mb-3">View Practical Ans</h2>         
        </div>
        <div class="container mt-5 card">
                ...
                <tbody>
                <?php 
                   $sql=mysqli_query($con,"SELECT * FROM `practical_ans`");
                   $srno=1;
    ...
    $arrstuddet=mysqli_fetch_array($studdet);
             ...
             <tr>
                 ...
                 <td>
                 <a href="view-practical_ans_stud.php?id=<?php echo $row['id']; ?>" class="text-primary" title="View">
                                <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>
                 </td>
            
                 <td>
                     <a href="acceptpractical.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Accept</a>
                 </td>
